...
K.options = {
	...
	layout : '<div class="container"><div class="toolbar"></div><div class="editor"></div><div class="statusbar"></div></div>'
};
...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
		...
		'	background-image:url(' + themesPath + 'core/flash.gif);',
		...
		'img.ke-rm {',
		'	border:1px solid #AAA;',
		'	background-image:url(' + themesPath + 'core/rm.gif);',
		'	background-position:center center;',
		'	background-repeat:no-repeat;',
		'	width:100px;',
		'	height:100px;',
		...
		'img.ke-media {',
		'	border:1px solid #AAA;',
		'	background-image:url(' + themesPath + 'core/media.gif);',
		'	background-position:center center;',
		'	background-repeat:no-repeat;',
		'	width:100px;',
		'	height:100px;',
...
_extend(KEdit, KWidget, {
	init : function(options) {
		...
		self.iframe = K('<iframe class="ke-editor-iframe" hidefocus="true" frameborder="0"' + iframeSrc + '></iframe>').css('width', '100%');
		self.textarea = K('<textarea class="ke-editor-textarea" hidefocus="true"></textarea>').css('width', '100%');
		if (self.width) {
...
_extend(KUploadButton, {
	init : function(options) {
		...
		var html = [
			...
			'<span class="ke-button-core">',
			hiddenElements.join(''),
			'<input type="button" class="ke-button-core ke-button" value="' + title + '" />',
			'</span>',
		...
		var width = options.width || K('.ke-button-core', div).width();
...
function _createButton(arg) {
	arg = arg || {};
	var name = arg.name || '',
		span = K('<span class="ke-button-core ke-button-outer" title="' + name + '"></span>'),
		btn = K('<input class="ke-button-core ke-button" type="button" value="' + name + '" />');
	if (arg.click) {
		btn.click(arg.click);
	}
	span.append(btn);
...
_plugin('core', function(K) {
	...
	_each('link,image,flash,media,anchor'.split(','), function(i, name) {
		...
		_each('editor,delete'.split(','), function(j, val) {
			self.addContextmenu({
				...
				width : 150,
				iconClass : val == 'editor' ? 'ke-icon-' + name : undefined
			});
		});
	...
	self.beforeSetHtml(function(html) {
		...
		return html.replace(/<embed[^>]*type="([^"]+)"[^>]*>(?:<\/embed>)?/ig, function(full) {
			...
			return _mediaImg(self.themesPath + 'core/blank.gif', attrs);
		})
		.replace(/<a[^>]*name="([^"]+)"[^>]*>(?:<\/a>)?/ig, function(full) {
			...
			return '<img class="ke-anchor" src="' + self.themesPath + 'core/anchor.gif" data-ke-name="' + escape(attrs.name) + '" />';
		})
...
KindEditor.plugin('baidumap', function(K) {
	...
	self.clickToolbar(name, function() {
		var html = ['<div style="padding:10px 20px;">',
			...
			'<span class="ke-button-core ke-button-outer">',
			'<input type="button" name="searchBtn" class="ke-button-core ke-button" value="' + lang.search + '" />',
			'</span>',
			'</div>',
			// right start
			'<div class="ke-right">',
	...
	self.plugin.flash = {
		edit : function() {
			var html = [
				...
				'<span class="ke-button-core ke-button-outer">',
				'<input type="button" class="ke-button-core ke-button" name="viewServer" value="' + lang.viewServer + '" />',
				'</span>',
				'</div>',
				//width
				'<div class="ke-dialog-row">',
			...
			var dialog = self.createDialog({
				...
				yesBtn : {
					...
					click : function(e) {
						...
						var html = K.mediaImg(self.themesPath + 'core/blank.gif', {
								src : url,
...
K.extend(KSWFUpload, {
	init : function(options) {
		...
		self.div = K(options.container).html([
			...
			'<span class="ke-button-core ke-button-outer ke-swfupload-startupload">',
			'<input type="button" class="ke-button-core ke-button" value="' + options.startButtonValue + '" />',
			'</span>',
			'</div>',

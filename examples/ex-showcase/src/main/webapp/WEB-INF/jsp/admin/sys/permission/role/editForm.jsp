    ...
    <ul class="nav nav-tabs">
        ...
        <c:if test="${op eq '新增'}">
            <li ${op eq '新增' ? 'class="active"' : ''}>
                <a href="${ctx}/admin/sys/permission/role/create?BackURL=<pg:BackURL/>">
        ...
        <c:if test="${not empty m.id}">
            <li ${op eq '查看' ? 'class="active"' : ''}>
                <a href="${ctx}/admin/sys/permission/role/${m.id}?BackURL=<pg:BackURL/>">
            ...
            <li ${op eq '修改' ? 'class="active"' : ''}>
                <a href="${ctx}/admin/sys/permission/role/${m.id}/update?BackURL=<pg:BackURL/>">
                    <i class="icon-edit"></i>
                    修改
                </a>
            </li>
            ...
            <li ${op eq '删除' ? 'class="active"' : ''}>
                <a href="${ctx}/admin/sys/permission/role/${m.id}/delete?BackURL=<pg:BackURL/>">
        ...
        <div id="resourcePermissionInfo" class="span10">
            ...
            <div id="selectedResourcePermssion" class="span9">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <c:if test="${pgfn:existsResource(o.resourceId, onlyDisplayShow)}">
                    <tr>
                        ...
                        <td>
                            ...
                            <c:if test="${pgfn:existsPermission(permissionId, onlyDisplayShow)}">
    ...
    $(function () {
        <c:choose>
            ...
            <c:otherwise>
                ...
                <pg:showFieldError commandName="m"/>
            </c:otherwise>
        </c:choose>

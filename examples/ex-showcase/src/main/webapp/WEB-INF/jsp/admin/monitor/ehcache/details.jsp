...
<div data-table="table" class="panel">
    ...
    <a href="<pg:BackURL/>" class="btn btn-link pull-right">返回</a>
    <a href="?BackURL=<pg:BackURL/>" class="btn btn-link pull-right">刷新</a>
...
$(function() {
    $("#searchText").keyup(function(event) {
        if(event.keyCode == 13) {
            window.location.href = "?searchText=" + this.value + "&BackURL=<pg:BackURL/>";
        }
    });

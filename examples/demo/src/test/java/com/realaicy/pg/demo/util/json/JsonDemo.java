package com.realaicy.pg.demo.util.json;
...
import com.realaicy.pg.core.mapper.JsonMapper;
...
public class JsonDemo {
    ...
    public void multiViewBean() throws IOException {
        ...
        assertEquals("{\"otherValue\":\"others\",\"name\":\"Foo\"}", publicWriter.writeValueAsString(multiViewBean));

        // internal view
        ObjectWriter internalWriter = mapper.getMapper().writerWithView(Views.Internal.class);
        assertEquals("{\"otherValue\":\"others\",\"age\":16}", internalWriter.writeValueAsString(multiViewBean));

package com.realaicy.pg.demo.util.dozer;

import com.realaicy.pg.core.mapper.BeanMapper;
...
public class DozerDemo {
    ...
    public void map() {
        ...
        // 原来的字符串被Map成Double。
        assertEquals((double) 200, product.getPrice());
    ...
    public void copy() {
        ...
        assertEquals((double) 20, product.getWeight());
        // Part中循环依赖的Product同样被赋值。
        assertEquals("car", product.getParts().get(0).getProduct().getProductName());
    }

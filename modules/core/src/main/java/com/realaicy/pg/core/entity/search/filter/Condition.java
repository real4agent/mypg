...
import com.realaicy.pg.core.entity.search.exception.InvlidSearchOperatorException;
...
public final class Condition implements SearchFilter {
     ...
     * <p>方法接受类似“("name_lick","XudongLiu")”的参数，并将其转换成标准的{@link Condition }
     * <P>方法首先判断key不为空，接着将“key”用{@link #separator }分解,得到查询的属性、查询的操作符，
     * 然后将“查询操作符不允许查询目标值为空而实际传进来的查询目标值为空的”这类查询过滤掉
     *
     ...
     * <p>方法接受类似“("name",“like”"XudongLiu")”的参数，并将其转换成标准的{@link Condition }
     *
     * @param searchProperty 查询属性
     * @param operator 操作符
     * @param value 待查询属性的目标值
     * @return {@link Condition }
     */
    ...
    /**
     * 是否是一元过滤 如is null 或者 is not null
     *
     * @return 如果为一元过滤则返回真
     */
    ...
    public boolean equals(Object o) {
        return this == o ||
                !(o == null || getClass() != o.getClass()) &&
                        !(key != null ? !key.equals(((Condition) o).key) : ((Condition) o).key != null);

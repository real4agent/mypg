 ...
 */
package com.realaicy.pg.core.spring;
...
public class SpeedUpSpringProcessor implements BeanFactoryPostProcessor {
    ...
    public static void main(String[] args) {
        String c = "com.realaicy.pg.sys.user.web.bind.A";
    ...
    private boolean needRemove(String beanName, BeanDefinition beanDefinition) {
        ...
        //spring data jpa
        if (className.equals("com.realaicy.pg.core.repository.support.SimpleBaseRepositoryFactoryBean") ||

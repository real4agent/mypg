package com.realaicy.pg.core.web.upload;

import com.realaicy.pg.core.utils.LogUtils;
import com.realaicy.pg.core.utils.security.Coder;
...
public class FileUploadUtils {
     ...
     * @return 返回上传成功的文件名
     * @throws com.realaicy.pg.core.web.upload.exception.InvalidExtensionException            如果MIME类型不允许
     * @throws org.apache.commons.fileupload.FileUploadBase.FileSizeLimitExceededException    如果超出最大大小
     * @throws com.realaicy.pg.core.web.upload.exception.FileNameLengthLimitExceededException 文件名太长
     ...
     *
     * @param file file
     * @param baseDir 上传文件所在的基目录
     * @param needDatePathAndRandomName 是否追加日期路径和随机名
     * @return 实际的文件名（相对于服务器所在系统）
     */

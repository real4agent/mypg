package com.realaicy.pg.core.entity.search.utils;
...
public final class SearchableConvertUtils {
                ...
                if (conversionService == null) {
                    try {
                        ...
                        throw new SearchException("conversionService is null, " +
                                ...
                                "please see [com.realaicy.pg.core.entity.search.utils." +
     ...
     * value="com.realaicy.pg.core.entity.search.utils.SearchableConvertUtils.setConversionService"/>
     * <property name="arguments" ref="conversionService"/>
     * </bean>
     *
     * @param conversionService spring内置转换辅助服务
     */
    ...
    /**
     * 将查找的属性的目标值转换成为对应实体可以接受的目标值
     * 首先判断是否已经转换，如果没有,则对于每一个 {@link Searchable}循环遍历其中的各个查询条件{@link SearchFilter},
     * 将各个查询条件中的目标值转换成为对应的实体的可以接受的目标值
     *
     * @param search 查询条件
